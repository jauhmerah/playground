            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view'],
                        'roles' => ['<?= Inflector::camel2id($modelClass) ?>-view'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['create'],
                        'roles' => ['<?= Inflector::camel2id($modelClass) ?>-create'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['update'],
                        'roles' => ['<?= Inflector::camel2id($modelClass) ?>-update'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['delete'],
                        'roles' => ['<?= Inflector::camel2id($modelClass) ?>-delete'],
                    ],
                ],
            ],
            'verbs' => [
